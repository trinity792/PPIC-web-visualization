...
/**
 * All 58 California counties, as the cleaned module CSVs label them (the
 * `Location` value at the County level, no "County" suffix). A v3 question
 * lists its places explicitly - an empty selection is unfinished, not "every
 * county" - so a built-in county ranking spells out the full set.
 */
export const CALIFORNIA_COUNTIES = Object.freeze([
