...
export const COMPONENTS_OF_CHANGE_SUBSET_SOURCE = Object.freeze({
  Regions: "DoF",
  Counties: "DoF",
  States: "Census",
});
...
export const COMPONENTS_OF_CHANGE_SCHEMA = Object.freeze({
  ...
  subsetSource: COMPONENTS_OF_CHANGE_SUBSET_SOURCE,
  ...
  time: Object.freeze({
    availablePeriods: Object.freeze(Array.from({ length: 34 }, (_, index) => 1991 + index)),
