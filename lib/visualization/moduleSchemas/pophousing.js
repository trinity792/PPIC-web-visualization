...
export const POPHOUSING_FIELDS = Object.freeze({
  ...
  Source: { kind: DIMENSION, label: "Source", values: ["DoF"] },
...
export const POPHOUSING_SCHEMA = Object.freeze({
  ...
  sources: null, // no DoF/Census source toggle for this module
  yearRange: [1991, 2025], // cleaned E-5 coverage; drives the year-range slider
});
