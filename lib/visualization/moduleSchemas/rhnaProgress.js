...
export const RHNA_PROGRESS_SCHEMA = Object.freeze({
  ...
  // Ranking bars plus their diverging variant (each jurisdiction's pace score
  // read against a reference line). Trend lines and maps stay deferred.
  supportedChartTypes: ["bar", "divergingBar"],
});
