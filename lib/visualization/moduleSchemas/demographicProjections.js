...
const AGE_GROUP_VALUES = ["All Ages", ...CANONICAL_AGE_GROUPS];
const SEX_VALUES = ["Both Sexes", "Female", "Male"];
const RACE_VALUES = ["All", "White", "Black", "Asian", "NHPI", "AIAN", "Multiracial", "Hispanic"];
...
export const DEMOGRAPHIC_PROJECTIONS_SCHEMA = Object.freeze({
  ...
  // No dataset toggle, deliberately. `sources` stays because the data layer,
  // validation, and `subsetSource` all need to know the two sources exist, but
  // the sidebar must not offer them as a choice: the API pairs DoF P-3 with the
  // California levels and Census cc-est with US States, and rejects any other
  // combination outright. A visible toggle let a reader pick Census cc-est while
  // sitting on Counties and get an error back instead of a chart. Selecting a
  // geographic level pins the matching source, which is the only way the pair
  // was ever valid.
  datasets: [],
  ...
  comparisonDimensions: Object.freeze([
    Object.freeze({ id: "Race/Ethnicity", values: RACE_VALUES }),
    Object.freeze({ id: "Sex", values: SEX_VALUES }),
    Object.freeze({ id: "Age Group", values: AGE_GROUP_VALUES }),
  ]),
  labelMeta: Object.freeze({
    dimensionOrder: Object.freeze(["geography", "Race/Ethnicity", "Sex", "Age Group"]),
    omitValues: Object.freeze({
      "Age Group": Object.freeze(["All Ages"]),
      Sex: Object.freeze(["Both Sexes"]),
      "Race/Ethnicity": Object.freeze(["All"]),
    }),
    valueLabels: Object.freeze({
      "Race/Ethnicity": Object.freeze({
        Hispanic: Object.freeze({
          default: "Latino",
          bySex: Object.freeze({ Female: "Latina" }),
        }),
      }),
      Sex: Object.freeze({ Female: "Women", Male: "Men" }),
    }),
    disambiguateBy: Object.freeze(["geography", "Source", "time"]),
  }),
  time: Object.freeze({
    availablePeriods: Object.freeze(Array.from({ length: 51 }, (_, index) => 2020 + index)),
    reportingPeriods: Object.freeze([2020, 2021, 2022, 2023, 2024, 2025]),
