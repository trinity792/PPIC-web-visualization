...
export const HOUSING_STRESS_SCHEMA = Object.freeze({
  ...
  // v3: mirrors demographicProjections — Race/Ethnicity and Tenure are real
  // comparison dimensions, not just sidebar filters.
  comparisonDimensions: Object.freeze([
    Object.freeze({ id: "Race/Ethnicity", values: RACE_VALUES }),
    Object.freeze({ id: "Tenure", values: TENURE_VALUES }),
  ]),
  labelMeta: Object.freeze({
    dimensionOrder: Object.freeze(["geography", "Race/Ethnicity", "Tenure"]),
    omitValues: Object.freeze({
      "Race/Ethnicity": Object.freeze(["All"]),
      Tenure: Object.freeze(["Total"]),
    }),
    disambiguateBy: Object.freeze(["geography", "time"]),
  }),
  time: Object.freeze({
    // ACS released no 1-year estimates for 2020 (pandemic data collection gap).
    availablePeriods: Object.freeze(
      Array.from({ length: 2024 - 2012 + 1 }, (_, index) => 2012 + index).filter(
        (year) => year !== 2020,
      ),
    ),
    reportingPeriods: Object.freeze([2024]),
