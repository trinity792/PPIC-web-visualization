...
export const CONTROL_TIERS = Object.freeze({
  ...
  tabOrder: { tier: "advanced", section: "encodings" },
  ...
  groupGap: { tier: "moderate", section: "appearance" },
  ...
  // Dashboard-style diverging-bar styling.
  valueRange: { tier: "moderate", section: "appearance" },
  trackRail: { tier: "moderate", section: "appearance" },
  minimalAxis: { tier: "moderate", section: "appearance" },
  colorBuckets: { tier: "advanced", section: "appearance" },
  ...
  // Decimal places for non-integer measure values (hover, ticks, value labels).
  decimalPlaces: { tier: "moderate", section: "appearance" },
