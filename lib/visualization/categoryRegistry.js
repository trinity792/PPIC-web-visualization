...
export const BUILT_IN_VIEWS = Object.freeze({
  ...
  "housing-units-heatmap": {
    version: 1,
    module: "pophousing",
    preset: "pattern-over-time",
    chartType: "heatmap",
    bindings: { x: "Year", y: "Location", color: "Total Housing Units" },
    filters: { subset: "Counties" },
    period: {},
    labels: {
      title: "Housing units by county",
      subtitle: "Total housing units over time",
    },
    transform: "actual",
    appearance: { colorScale: "sequential" },
    referenceLines: [],
    layers: [],
  },
});
...
export const CATEGORIES = Object.freeze([
  {
    ...
    status: "live",
    // Landing layout: two chart tiles (area + heatmap), a stat-card row, then a
    // chart tile + the region table (see app/page.js).
    previews: [
      { id: "population-area", modulePath: "/pophousing" },
      { id: "housing-units-heatmap", modulePath: "/pophousing" },
