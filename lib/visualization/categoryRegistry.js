...
export const CATEGORIES = Object.freeze([
  ...
  },
  {
    ...
    // Temporarily withheld from the landing page: the module is built, but its
    // change-detection defects (see the RHNA module specification's Flagged Issues)
    // mean a pipeline re-run duplicates every row, so the published data cannot be
    // refreshed yet. Restore to "live" once those are fixed and a clean run lands.
    status: "coming-soon",
