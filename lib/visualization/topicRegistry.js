 ...
 * route. Display names are NOT stored here — `getTopicLabel` reads the name
 * off the module schema, and `getTopicHref` derives every editor route from
 * the module id (all six open in the v3 editor since the 2026-09-14 cutover).
 * Documentation routes are intentionally hardcoded here until document/topic
 * relationships are represented in document metadata.
 *
...
export const TOPICS = Object.freeze([
  Object.freeze({
    ...
    documentationHref: "/documents/population-and-housing-topic-guide",
  }),
  Object.freeze({
    ...
    documentationHref: "/documents/components-of-change-topic-guide",
  }),
  Object.freeze({
    ...
    documentationHref: "/documents/age-sex-race-projections-topic-guide",
  }),
  Object.freeze({
    id: "housing-stress",
    ...
    documentationHref: "/documents/acs-housing-stress-topic-guide",
  }),
  Object.freeze({
    id: "building-permits",
    ...
    documentationHref: "/documents/building-permits-topic-guide",
  }),
  Object.freeze({
    id: "rhna-progress",
...
/** Route into the topic's chart editor. */
