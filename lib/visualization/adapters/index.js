...
function decimalPlaces(appearance = {}) {
  const raw = Number(appearance.decimalPlaces);
...
function verticalNumberFormat(observations, appearance = {}) {
  const explicitType = appearance.verticalNumberType;
