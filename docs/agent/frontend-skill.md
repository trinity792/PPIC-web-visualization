...
Most components are short enough that only Level 2 headers are needed (or none at all). Reserve Level 1 for files over ~200 lines, such as complex page orchestrators or large utility files.
