...
pinned: false
description: "Refactoring plan for migrating the legacy housingstress_code.py module into the V3 architecture established by PopHousing, Components of Change, and Age-Sex-Race Projections."
